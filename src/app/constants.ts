...
export const colorOptions: string[] = [
    "var(--color-option-one)",
    "var(--color-option-two)",
    "var(--color-option-three)",
    "var(--color-option-four)",
    "var(--color-option-five)",
    "var(--color-option-six)"
];
...
export const maxAttempts: number = 6;
export const timer: number = 60;

//Regional
export const regionsOrder: string[] = ["kanto", "johto", "hoenn", "sinnoh", "unova", "kalos", "alola", "galar", "paldea", "tournament"];

//Champions
export const championsOrder: string[] = ["lance", "iris", "steven", "diantha", "cynthia", "leon", "ash"];
